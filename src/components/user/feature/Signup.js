              ...
              <div className='card'>
                ...
                <div className="card-body">
                  <div className='my-4'>
                    ...
                    <input type='text' name='name' onChange={signupForm.handleChange} className={'form-control ' + (signupForm.errors.email && signupForm.touched.email ? 'is-invalid' : '')}  />
                    {
                  ...
                  <div className='my-4'>
                    ...
                    <input type='password' name='password' onChange={signupForm.handleChange} className={'form-control ' + (signupForm.errors.email && signupForm.touched.email ? 'is-invalid' : '')} />
                    {
                  ...
                  <div className='my-4'>
                    ...
                    <input type='password' name='repassword' onChange={signupForm.handleChange} className={'form-control ' + (signupForm.errors.email && signupForm.touched.email ? 'is-invalid' : '')} />
                    {
                  ...
                  <div className='my-4'>
                    <label>Contact</label>
                    <input type='text' name='contact' onChange={signupForm.handleChange} className={'form-control ' + (signupForm.errors.email && signupForm.touched.email ? 'is-invalid' : '')} />
                    {
                  ...
                  <div className='my-4'>
                    <label>Address</label>
                    <textarea className={'form-control ' + (signupForm.errors.email && signupForm.touched.email ? 'is-invalid' : '')} name='address' onChange={signupForm.handleChange} ></textarea>
                    {
                  ...
                  <div className='my-4'>
                    <label>State</label>
                    <select name='state' onChange={(event)=>{getcity(event); signupForm.handleChange(event)}} className={'form-control ' + (signupForm.errors.email && signupForm.touched.email ? 'is-invalid' : '')} >
                  ...
                  <div className='my-4'>
                    <label>City</label>
                    <select className={'form-control ' + (signupForm.errors.email && signupForm.touched.email ? 'is-invalid' : '')} name='city' onChange={signupForm.handleChange}>
                      <option>Select</option>
                      {
